  ...
  <section className="py-24">
    <div className="container">
      <motion.div
        ...
        className="mb-12"
      >
        <p className="text-sm font-semibold text-primary tracking-widest uppercase mb-2">Products</p>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {products.map((product, i) => (
          <motion.div
            ...
            className="p-6 rounded-xl border border-border bg-card hover:border-primary/30 hover:shadow-md transition-all duration-300"
          >
      ...
      <Link to="/products" className="inline-flex items-center gap-2 text-sm text-primary hover:underline font-medium">
